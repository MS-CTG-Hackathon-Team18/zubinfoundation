...
export default async function EventDetails ({params}) {
  const event_id = params.events_id;
  // console.log("event_id:", event_id)
  const specificEventData = await getEventDetails({ eventId: event_id });
  console.log('specificEventData', specificEventData);
        ...
        <div className="flex flex-col justify-start align-middle items-center">
          <div className="flex flex-col first:w-[80vw] overflow-hidden text-black font-sans">
            ...
            <div className="flex justify-between">
              <span className="text-6xl font-bold">{specificEventData.data.event_name}</span>
            ...
            <span className="flex my-2">
              <Image
                ...
                height={20}
              />
              {specificEventData.data.event_date.slice(0, 10)}
            </span>
            ...
            <span className="flex my-2">
              <Image
                ...
                height={20}
              />
              {specificEventData.data.location}
            </span>
