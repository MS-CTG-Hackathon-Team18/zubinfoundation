  ...
  return (
    ...
    <>
      ...
      <div className="flex flex-col justify-start align-middle items-center">
        <div className="w-[80vw] h-[50vh] mt-10 mb-8 shadow-lg overflow-hidden"> {/* Event Picture Div */}
          <Image
            src={ImageTesting1}
      ...
      <div className="flex flex-col justify-start align-middle items-center">
        <div className="flex flex-col first:w-[80vw] overflow-hidden text-black font-sans"> {/* Event Picture Div */}
                ...
                <CardFooter className="flex justify-between gap-4">
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button variant="outline" className="">Volunteer</Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                        <AlertDialogDescription>
                          You can view all your registered events on your account later.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
          ...
          <span className="mt-6 text-2xl font-bold">
            Date and Time
          </span>
          <span className="flex my-2"><Image className="mx-2" src={calendarSVG} alt="My SVG Image" width={20} height={20}/>
          ...
          <span className="flex my-2"><Image className="mx-2" src={poiSVG} alt="My SVG Image" width={20} height={20}/>
